...
$route['l'] = "store/lookup_policy";
$route['l/(:any)'] = "store/lookup_policy/$1";
...
$route['store/change_password'] = "store/change_password";
...
$route['store/retrieve_payment/(:any)'] = "store/retrievepayment/$1";
...
// Extended routes and API routes

// migration
$route["migration/migrate/latest"] = "Migration/latest";
$route["migration/migrate/(:any)"] = "Migration/migrateToVersion/$1";

// address
$route["api/v1/provinces"]["get"] = "extends/AddressController/getAllProvinces";
$route["api/v1/districts"]["get"] = "extends/AddressController/getAllDistrictsByProvinceId";
$route["api/v1/wards"]["get"] = "extends/AddressController/getAllWardsByDistrictId";
$route["api/v1/cart-items/many"]["post"] = "Store/calculate_cart_unit_price";
$route["api/v1/order/payment/(:any)"]["get"] = "Store/retrieve_orders_payment_data/$1";

// order
// $route["api/v1/orders/ipn"]["post"] = "Order/receive_payment_notification";

// car insurance prodcut
$route["api/v1/car-product/makers"]["get"] = "extends/CarInsuranceProductController/getAllMakers";
$route["api/v1/car-product/models"]["get"] = "extends/CarInsuranceProductController/getAllModelsByMaker";
$route["api/v1/car-product"]["get"] = "extends/CarInsuranceProductController/getCarValueByFilter";
$route["v1/policies/(:any)"]["get"] = "Store/get_policies/$1";
