...
$pageSetting['admincontrol_manage_car_value'] = array(
	'title' => 'Manage Car Value',
	'breadcrumb' => array(
		array(
			'title' =>  __('admin.page_title_dashboard'),
			'link' =>  base_url('admincontrol/dashboard'),
		...
		array(
			'title' =>  __('admin.page_title_managecarvalue'),
			'link' =>  base_url('admincontrol/manage_car_value'),
		),
	),
);
...
// TODO: enable this feature if needed
