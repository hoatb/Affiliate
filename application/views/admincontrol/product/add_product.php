	...
	<div class="row">
		<div class="col-sm-8">
			<div class="form-group">
				...
				<div>
					<input
						placeholder="<?= __('admin.product_msrp_placeholder') ?>"
						name="product_msrp"
						class="form-control"
			...
			<div class="form-group">
				...
				<div>
					<input
						placeholder="<?= __('admin.enter_your_product_price') ?>"
						name="product_price"
						class="form-control"
			...
			<!-- Product suggested price section - Start -->
			<div class="form-group">
				<label class="col-form-label"><?= __('admin.product_suggested_price') ?></label>
				<div>
					<input
						placeholder="<?= __('admin.enter_your_product_suggested_price') ?>"
						name="product_suggested_price"
						class="form-control"
						value="<?php echo $product->product_suggested_price; ?>"
						type="number"
						min="0"
					>
				</div>
			</div>
			<!-- Product suggested price section - End -->
		...
		<div class="col-sm-4">
			...
			<div class="form-group form-image-group">
				<div>
					<label class="col-form-label"><?= __('admin.product_banner') ?></label>
					<div class="fileUpload btn btn-sm btn-primary">
						<span><?= __('admin.choose_file') ?></span>
						<input onchange="readURLBanner(this)" id="product_banner" name="product_banner" class="upload" type="file">
					</div>
					<?php $product_banner = $product->product_banner != '' ? 'assets/images/product/upload/thumb/' . $product->product_banner : 'assets/images/no_product_image.png' ; ?>
					<img src="<?php echo base_url($product_banner); ?>" id="bannerImage" class="thumbnail" border="0" width="220px">
				</div>
			</div>
...
<!-- Config reference information between affiliate's product and Insurance Core's product ------Start -->
<div class="col-sm-12">
	<div class="card">
		<div class="card-header change-category-color">
			<h4 class="header-title">Product Reference Settings</h4>
		</div>

		<div class="card-body">
			<div class="row form-group">
				<div class="col-sm-4">
					<label class="col-form-label" for="product-template-select">Product Template</label>
					<select class="form-control" id="product-template-select" name="product_template_code">
					<?php foreach ($product_templates_config as $key => $value) { ?>
						<option
							value="<?= $value->product_template_code ?>"
							<?= $product_insurcore_references && $product_insurcore_references->product_template_code === $value->product_template_code ? "selected" : "" ?>
						>
							<?= $value->product_template_name ?>
						</option>
					<?php }?>
					</select>
				</div>
			...
			<fieldset class="custom-design mb-3 product-reference-information d-none">
				<legend>Sales Product</legend>
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label for="">Sales Product Code</label>
							<input
								type="text"
								class="form-control"
								placeholder="Input your Sales Product Code"
								name="sales_product_code"
								value='<?= $product_insurcore_references ? $product_insurcore_references->sales_product_code : "" ?>'
							>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="">Sales Product Id</label>
							<input
								type="text"
								class="form-control"
								placeholder="Input your Sales Product Id"
								name="sales_product_id"
								value='<?= $product_insurcore_references ? $product_insurcore_references->sales_product_id : "" ?>'
							>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col">
						<div class="form-group">
							<label for="">Sales Product Name</label>
							<input
								type="text"
								class="form-control"
								placeholder="Input your Sales Product Name"
								name="sales_product_name"
								value='<?= $product_insurcore_references ? $product_insurcore_references->sales_product_name : "" ?>'
							>
						</div>
					</div>
				</div>
			...
			<fieldset class="custom-design mb-3 product-reference-information d-none">
				<legend>Policy Template</legend>
				<div class="row">
					<div class="col-sm-6">
						<div class="form-group">
							<label for="">Policy Template Code</label>
							<input
								type="text"
								class="form-control"
								placeholder="Input your Policy Template Code"
								name="policy_template_code"
								value='<?= $product_insurcore_references ? $product_insurcore_references->policy_template_code : "" ?>'
							>
						</div>
					</div>
					...
					<div class="col-sm-6">
						<div class="form-group">
							<label for="">Policy Template Id</label>
							<input
								type="text"
								class="form-control"
								placeholder="Input your Policy Template Id"
								name="policy_template_id"
								value='<?= $product_insurcore_references ? $product_insurcore_references->policy_template_id : "" ?>'
							>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col">
						<div class="form-group">
							<label for="">Policy Template Name</label>
							<input
								type="text"
								class="form-control"
								placeholder="Input your Policy Template Name"
								name="policy_template_name"
								value='<?= $product_insurcore_references ? $product_insurcore_references->policy_template_name : "" ?>'
							>
						</div>
					</div>
				</div>
			...
			<script type="text/javascript">
				function toggleReferenceArea() {
					const selectedValue = $("#product-template-select").val();

					if (selectedValue === "default") {
						$(".product-reference-information").addClass("d-none");
					} else {
						$(".product-reference-information").removeClass("d-none");
					}
				}
				$("#product-template-select").change(toggleReferenceArea);
				$("#product-template-select").ready(toggleReferenceArea)
			</script>
		</div>
	</div>
</div>
<!-- Config reference information between affiliate's product and Insurance Core's product ------End -->
