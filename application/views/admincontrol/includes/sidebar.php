  ...
  <div class="scroll-bar d-block sidebar">
      ...
      <li id="sidebar_membership" class="nav-item dropdown" <?= $sidebar_data['membership_is_enable'] == 0 ? 'style="display:none;"' : ''; ?>>
        ...
        <div class="dropdown-menu">
          ...
          <div class="dashboard-div1 sidebarshare mt-5" pt-5>
          <div class="link-details">
              <?php $share_url = base_url('register/vendor'); ?>
              <div class="user-header d-flex align-items-center border-0 p-0">
                  <div>
                      <h3 class="bg-blue-dark"><?= __('admin.register_new_vendor_account_link') ?></h3>
                  </div>
              </div>
          ...
          <div class="link-details mt-3">
              ...
              <div class="user-header d-flex align-items-center border-0 p-0">
                  <div>
                      <h3 class="bg-blue-dark"><?= __('admin.register_new_affiliate_account_link') ?></h3>
                  </div>
              </div>
              <div class="link-area d-flex">
                  <input id="unique_re_link" type="text" readonly="readonly" value="<?= $share_url ?>">
