...
<script type="text/javascript">
  ...
  <script>
    ...
    function sumNote(element, toolbar = null){
  ...
  $(function() {
    if($('.left-menu ul>li>.dropdown-menu a.active').length!=0){
      ...
      $('.left-menu div.scroll-bar').animate({
        scrollTop: activeMenuItem.offset().top - ($('.left-menu div.scroll-bar').height() / 1.5)
      }, 500);
    }
  });
</script>
