<div class="col-sm-12">
    <div class="img-tool">
        <a href="<?php echo $parent; ?>" data-toggle="tooltip" title="<?= __('admin.parent') ?>" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> 
        <a href="<?php echo $url; ?>" data-toggle="tooltip" title="<?= __('admin.refresh') ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
        <button type="button" data-toggle="tooltip" title="<?= __('admin.upload') ?>" id="button-upload" class="btn btn-primary"><i class="fa fa-upload"></i></button>
        <button type="button" data-toggle="tooltip" title="<?= __('admin.make_folder') ?>" id="button-folder" class="btn btn-default"><i class="fa fa-folder"></i></button>
        <button type="button" data-toggle="tooltip" title="<?= __('admin.delete') ?>" id="button-delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></button>
    </div>
</div>
<hr />
<br><br>
