        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header"><h3><?= __('admin.default_template') ?></h3></div>
                    <div class="card-body">
                        <form method="post" action="" enctype="multipart/form-data">
                            <div class="row front-design-form vc">
                                <div class="col-sm-2">
                                    <div>
                                        <ul class="card1-list">
                                            <li data-show='content' class="active"><?= __('admin.home_content') ?></li>
                                            <li data-show='about-content'><?= __('admin.about_content') ?></li>
                                            <li data-show='heading'><?= __('admin.heading_settings') ?></li>
                                            <li data-show='inputs'><?= __('admin.inputs_settings') ?></li>
                                            <li data-show='bgcolor'><?= __('admin.background_color') ?></li>
                                            <li data-show='footersettings'><?= __('admin.footer_settings') ?></li>
                                            <li data-show='buttons'><?= __('admin.buttons') ?></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="col-sm-10">
                                    <div>
                                        <div class="card1 active" data-toggle='content'>
                                            <div class="card1-header"><?= __('admin.content') ?></div>
                                        ...
                                        <div class="card1" data-toggle='about-content'>
                                            <div class="card1-header"><?= __('admin.about_content') ?></div>
                                            <div class="card1-body">
                                                <table class="table-striped table">
                                                    <tr>
                                                        <td><?= __('admin.about_content') ?></td>
                                        ...
                                        <div class="card1" data-toggle='heading'>
                                            <div class="card1-header"><?= __('admin.heading_settings') ?></div>
                                            <div class="card1-body">
                                                <table class="table-striped table">
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td><?= __('admin.content') ?><?= __('admin.color') ?></td>
                                        ...
                                        <div class="card1" data-toggle='inputs'>
                                            <div class="card1-header"><?= __('admin.inputs_settings') ?></div>
                                            <div class="card1-body">
                                                <table class="table-striped table">
                                                    <tr>
                                        ...
                                        <div class="card1" data-toggle='bgcolor'>
                                            <div class="card1-header"><?= __('admin.background_color') ?></div>
                                            <div class="card1-body">
                                                <table class="table-striped table">
                                                    <tr>
                                                        <td><?= __('admin.left_side_background_color') ?></td>
                                        ...
                                        <div class="card1" data-toggle='footersettings'>
                                            <div class="card1-header"><?= __('admin.footer_settings') ?></div>
                                            <div class="card1-body">
                                                <table class="table-striped table">
                                                    <tr>
                                                        <td><?= __('admin.background_color') ?></td>
                                        ...
                                        <div class="card1" data-toggle='buttons'>
                                            <div class="card1-header"><?= __('admin.buttons') ?></div>
                                            <div class="card1-body">
                                                <table class="table-striped table">
                                                    <tr>
                                                        <td><?= __('admin.send_mail_button') ?></td>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td><?= __('admin.background_color') ?></td>
                                                    ...
                                                    <tr>
                                                        <td><?= __('admin.back_to_login_button') ?></td>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td><?= __('admin.background_color') ?></td>
                                                    ...
                                                    <tr>
                                                        <td><?= __('admin.forgot_password') ?></td>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td><?= __('admin.background_color') ?></td>
                                                    ...
                                                    <tr>
                                                        <td><?= __('admin.regiter_submit_button') ?></td>
                                                        <td>
                                                            <table>
                                                                <tr>
                                                                    <td><?= __('admin.background_color') ?></td>
