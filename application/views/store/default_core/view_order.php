			...
			<div class="profile-main">
				...
				<div class="my-orders my-order-details">
					<div class="cart-wrapper">
						...
						<div class="download">
						<?php if($order['status'] == 1 && ($product['product_type'] == 'downloadable' || $product['product_type'] =='video' || $product['product_type'] =='videolink') && $product['downloadable_files']) {  if ($product['product_type'] =='video' || $product['product_type'] =='videolink') { ?>
  							<p>
							...
							<?php foreach ($product['downloadable_files'] as $downloadable_filess) { ?>
								<a href="<?php echo base_url('store/downloadable_file/'. $downloadable_filess['name'] . '/' .$downloadable_filess['mask'])."/".$order_id ?>" target="_blank"><?php echo $downloadable_filess['mask'] ?></a>
							<?php } ?>
