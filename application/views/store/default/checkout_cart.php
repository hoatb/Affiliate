...
<form id="checkout-cart-form">
  ...
  <ul class="cart-header">
			...
			<?php foreach ($products as $key => $product) { ?>
				...
				<li class="cart-item-price cart-item-price-border-top text-right">
				...
				<li class="cart-item-price text-right">
					<label>Thành tiền: </label><span class="cart-mini-total-item"><?= c_format($product['total']) ?></span>
				</li>
				<li class="d-none">
