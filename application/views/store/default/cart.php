		...
		<form method="POST" id="cart-form">
			...
			<?php } else { ?>
				<div class="text-center">
					<div class="pic" style="max-width: 400px;margin: auto">
						<img class="mt-4" src="<?= base_url('assets/store/default/img/empty-cart.png') ?>"><br/>
					</div>
					<h3 class="m-0 mb-4"><?= __('store.shopping_cart_is_empty') ?></h3>
