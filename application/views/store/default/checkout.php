						...
						<div class="col-md-5">
							<div class="card shadow-sm border-top-card">
								<div class="card-body p-md-5">
									...
									<!-- <button id="btnGuestcontinues" class="btn btn-primary btn-submit w-100 mt-3"><?= __('store.guest_checkout') ?></button> -->
								</div>
							</div>
						</div>
						<div class="col-md-2 pt-md-5 text-center">
...
<script type="text/javascript">
	...
	$(".confirm-order").on('click',function(){
		...
		formData.append('extraData', localStorage.getItem('extraData'));
