									...
									<div class="panel panel-default">
										<div class="panel-heading card-header bg-secondary" role="tab" id="headingThree">
											<h4 class="panel-title ">
												<a class="collapsed" id="replyToggle" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree" class="text-white" style="color: white;">
